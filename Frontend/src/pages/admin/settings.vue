...
const canSaveProfile = computed(() => {
  if (!canEditIam.value) return false;
        ...
        <el-tabs v-model="activeTab" class="settings-tabs">
          ...
          <el-tab-pane name="account">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
              <el-card shadow="never" class="lg:col-span-2">
                <template #header>
                  <div class="flex items-center justify-between">
                    ...
                    <div class="flex items-center gap-2">
                      ...
                      <el-tag v-if="!canEditIam" type="warning"
                        >Read-only</el-tag
                      >
                    </div>
                  </div>
                ...
                >
                  ...
                  <div class="card-actions" v-if="canEditIam">
                    <BaseButton
                      type="primary"
                      size="small"
                  ...
                  <el-alert
                    v-if="canEditIam && profileChanged"
                    class="mt-4"
                    type="info"
                    show-icon
                    :closable="false"
            ...
            <el-card shadow="never" class="mt-4">
              ...
              <div
                v-if="user?.role === Role.STUDENT"
                class="mt-3 text-sm hint-text"
              >
                ...
                >
                  ...
                  <div class="card-actions">
                    <BaseButton
                      ...
                      :loading="changingPw"
                      :disabled="
                        !canChangePassword || changingPw || !canEditIam
                      "
                  ...
                  <el-alert
                    ...
                    show-icon
                    :closable="false"
                    title="After changing password, you will be logged out and must sign in again."
                  />
                </el-form>
              </el-card>
          ...
          <el-tab-pane name="appearance">
            ...
            <el-card shadow="never">
              ...
              <el-alert
                ...
                show-icon
                :closable="false"
                title="Theme is controlled by your CSS variables (light/dark)."
              />
            </el-card>
          </el-tab-pane>
                ...
                <div class="space-y-4">
                  <div class="flex items-start justify-between gap-4">
                    <div class="min-w-0">
                      ...
                      <div class="text-sm text-[var(--muted-color)]">
                        Applies to paginated tables (Users, Staff, etc.).
                        Recommended:
