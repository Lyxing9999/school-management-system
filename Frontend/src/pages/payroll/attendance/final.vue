...
<template>
  <OverviewHeader
    :title="'Final Attendance Input'"
    :description="'Attendance records used as payroll calculation input'"
    :backPath="'/payroll/dashboard'"
  >
    <template #actions>
      <BaseButton
        plain
  ...
  >
    <template #status="{ row }">
      <ElTag :type="statusTagType(row.status)" effect="plain" round size="small">
