...
class Response:
    ...
    @staticmethod
    def error_response(message: str = "An error occurred", user_message: Optional[str] = None, data: Optional[Any] = None, code: str = "ERROR", meta: Optional[Dict[str, Any]] = None,
        ...
        response = {"success": success,"message": message,"user_message": user_message,"data": data,"details": details,"code": code,"meta": meta,"error": errors,"category": category.value if isinstance(category, Enum) else category,"severity": severity.value if isinstance(severity, Enum) else severity,"hint": hint,"recoverable": recoverable,}
    ...
    def _prepare_error_response(
        *,
        ...
        if serialize_success:
            success = serialize_for_json(success)
